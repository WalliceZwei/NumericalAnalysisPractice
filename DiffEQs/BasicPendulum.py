...
solution_points = ExplicitTrapezoid(pendfunc, (0,np.array([.1,0])), .05, 100) 
solution_points2 = ExplicitTrapezoid(pendfunc, (0,np.array([0,.1])), .05, 100) 
solution_points3 = ExplicitTrapezoid(pendfunc, (0,np.array([math.pi/2,0])), .01, 500) 
solution_points4 = ExplicitTrapezoid(pendfunc, (0,np.array([3,0])), .01, 500) 
...
plt.scatter(t_values3, y_values3, label='pi/2 radians, 0 velo', color='blue', marker='+')
