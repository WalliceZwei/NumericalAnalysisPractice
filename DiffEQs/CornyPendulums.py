...
solution_points = ExplicitTrapezoid(
    dampedpendfunc, (0, np.array([math.pi / 3, 0])), 0.05, 100
)
solution_points2 = ExplicitTrapezoid(
    forceddampedpendfunc, (0, np.array([math.pi / 3, 0.1])), 0.05, 100
)
...
plt.scatter(
    t_values,
    y_values,
    label="60 degrees, 0 velo, damped, d = 1",
    color="red",
    marker="o",
)
plt.scatter(
    t_values2,
    y_values2,
    label="60 degrees, 0 velo, forceddamped, d = 1, A = 10",
    color="black",
    marker="x",
)
